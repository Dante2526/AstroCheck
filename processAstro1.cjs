...
async function processImage() {
  ...
  for(let i = 0; i < data.length; i += 4) {
    ...
    // If it's the moon (yellow-ish) we can also adjust it, but let's just leave it or make it white too? 
    // The sleeping astronaut is hugging a yellow crescent moon. We might want to keep the moon yellow.
    // Moon is yellow: hue is ~60 degrees (0.16)
